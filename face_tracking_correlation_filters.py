"""
Face tracking using dlib frontal face detector for initialization and dlib discriminative correlation
filter tracker
"""
import cv2
import dlib
...
def draw_text_info():
    ...
    #Write text
    cv2.putText(frame, "Use '1' to initialize tracking", menu_pos_1, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255))
    if tracking_face:
